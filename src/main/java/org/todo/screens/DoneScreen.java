...
public class DoneScreen implements Screen {
    ...
    public DoneScreen(DatabaseOperations dbOperations) {
    ...
    private void renderContent(List<Task> tasks) {
        GUI_General_Show_Content.showContent(tasks, searchField.getText(), sortCriterion, List.of(new FilterCriterion(FilterCriterion.Criterion.DONE, false)), "Keine abgeschlossenen Aufgaben vorhanden", "Keine abgeschlossenen Aufgaben gefunden", dbOperations);
    }
